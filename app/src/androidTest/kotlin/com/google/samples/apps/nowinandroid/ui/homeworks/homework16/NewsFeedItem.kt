...
class NewsFeedItem(semanticNode: SemanticsNode, semanticsProvider: SemanticsNodeInteractionsProvider) :
    KLazyListItemNode<NewsFeedItem>(semanticNode, semanticsProvider) {
