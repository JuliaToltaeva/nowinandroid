...
class ComposeTests : TestCase(Kaspresso.Builder.withComposeSupport()) {
    @get:Rule
    val composeTestRule = createAndroidComposeRule<MainActivity>()
    val composeOnboardingTest = ComposeOnboardingScreen(composeTestRule)
    val composeSearchTest = ComposeSearchScreen(composeTestRule)
